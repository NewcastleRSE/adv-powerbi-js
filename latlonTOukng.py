...
def WGS84toOSGB36(lat, lon):
    ...
    mypi_val = 3.1415926535897932384626
    lat_1 = lat * mypi_val / 180
    lon_1 = lon * mypi_val / 180
    ...
    rx, ry, rz = rxs * mypi_val / (180 * 3600.), rys * mypi_val / (180 * 3600.), rzs * mypi_val / (180 * 3600.)  #In radians
    ...
    lat0 = 49 * mypi_val / 180  #Latitude of true origin (radians)
    lon0 = -2 * mypi_val / 180  #Longtitude of true origin and central meridian (radians)
